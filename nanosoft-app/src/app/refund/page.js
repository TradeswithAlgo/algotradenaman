    ...
    <>
      ...
      <div className="pt-[80px] pb-[30px]">
        ...
        <div className="px-[5%] xl:px-[25%]">
          <h1 className="text-left text-[6vh] font-bold text-black   pt-[30px]">Refund Policy</h1>
          <li className="text-left text-[#555555] text-[1.75vh] pt-[10px]">On certain conditions we may initiate your refund.</li>
          <li className="text-left text-[#555555] text-[1.75vh] pt-[10px]">Wrong commitment from our executive side.</li>
          <li className="text-left text-[#555555] text-[1.75vh] pt-[10px]">
            If we are unable to provide you or activate your service before 72
            hours.
          </li>
          <li className="text-left text-[#555555] text-[1.75vh] pt-[10px]">Payment from the customer below 18 or 65+.</li>
          <li className="text-left text-[#555555] text-[1.75vh] pt-[10px]">
            {
