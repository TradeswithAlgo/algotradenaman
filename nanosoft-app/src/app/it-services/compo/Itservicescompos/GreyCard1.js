...
function GreyCard1({ title, description, imgSrc, footerNote, index, setIsOpen }) {
  return (
    <div
    ...
    >
      ...
      <a onClick={() => setIsOpen(index)}>
      <div  className="text-blue-400 text-center py-1 font-semibold cursor-pointer w-full mx-auto transition-all duration-300 ease-in-out hover:bg-pink-600 hover:text-white hover:w-[65%]">
        {footerNote} &#8599;
      </div>
      </a>
    </div>
